...
{
    public class InternationalLicense :BuisnessApplication
    {
...

        {
            ...
            this.ApplicationTypeId = (int)BuisnessApplication.enApplicationType.NewInternationalLicense;
...

        {
            ...
            base.ApplicationTypeId = (int)BuisnessApplication.enApplicationType.NewInternationalLicense;
            ...
            this.DriverInfo = Driver.FindByID(this.DriverID);
        ...
        public bool Save()
        {
            ...
            base.Mode = (BuisnessApplication.enBaseMode)Mode;
            if (!base.Save())
                return false;
